...
- **Repository**: A GitHub code repository (durion-moqui-frontend)
- **Story**: A functional user story issue (not an epic[brs], task, or bug)
...
1. WHEN the agent evaluates an issue THEN the system SHALL verify the repository is durion-moqui-frontend
2. WHEN the agent evaluates an issue THEN the system SHALL verify the issue title contains [FRONTEND] [STORY]
